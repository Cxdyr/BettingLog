Application that allows for the user to register and login, then enter a +- double that updates when saved and a string of text that is saved and can be updated each session.
